    ...
    public struct Password
    {
        ...
        private bool Validate()
        {
            if (string.IsNullOrWhiteSpace(_value))
                return AddNotification("The password is required.");

            if(_value.Length < 6)
                return AddNotification("The password must have more than 6 chars. A secure password (optional) is at least 8 characters long and contains at least one upper, one lower case character and one number.");
